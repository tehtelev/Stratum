...
# Builds Release if the launcher is missing, materializes the install with one
...
server_dir="$repo_root/StratumServer/bin/Release/${framework:-net10.0}"
...
VINTAGE_STORY="$server_dir" dotnet test tests/StratumScenarios -c Release "$@"
